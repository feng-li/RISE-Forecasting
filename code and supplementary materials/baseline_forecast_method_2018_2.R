...
for(i in 1:20)
{
  ...
  arimastlC2018[,i]=finfore
}

#Method 1: The trend term uses the base model forecast, the seasonal term 
#and the error term uses the average of the corresponding months over the past 3 years.
etsstlA2018=matrix(0,24,20)
...
for(i in 1:20)
{
  ...
  etsstlA2018[,i]=finfore
}

#Method 2: The trend term uses the base model forecast, 
#the seasonal term and the error term uses the values of the corresponding month in the past year.
etsstlB2018=matrix(0,24,20)
...
for(i in 1:20)
{
  ...
  etsstlB2018[,i]=finfore
}

#Method 3: All three sequences are predicted using the underlying model.
etsstlC2018=matrix(0,24,20)
...
for(i in 1:20)
{
  ...
  etsstlC2018[,i]=finfore
}

file_path='D:\\university\\研究生\\tourism_forecasting_competition\\submit\\stacking_train\\'
setwd(file_path)
write.xlsx(data.frame(arimastlA2018),'arimastlA2018.xlsx')
write.xlsx(data.frame(arimastlB2018),'arimastlB2018.xlsx')
write.xlsx(data.frame(arimastlC2018),'arimastlC2018.xlsx')
write.xlsx(data.frame(etsstlA2018),'etsstlA2018.xlsx')
write.xlsx(data.frame(etsstlB2018),'etsstlB2018.xlsx')
write.xlsx(data.frame(etsstlC2018),'etsstlC2018.xlsx')
